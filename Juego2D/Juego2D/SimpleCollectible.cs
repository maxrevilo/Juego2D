...
namespace Juego2D
{
    ...
    {
        public SimpleCollectible(GameScreen gameScreen, Vector2 position, World world, Camera2D camera)
        ...
        {
            Texture2D sheet = contentManager.Load<Texture2D>("collectibleLeche");
        ...
        {
            UserProfileManger.getProfile().simpleRecolected++;
            image.Visible = false;
            return true;
        }
    }
